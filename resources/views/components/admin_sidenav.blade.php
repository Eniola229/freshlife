<nav id="sidebar" class="sidebar js-sidebar">
    <div class="sidebar-content js-simplebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item {{ request()->is('adminHome') ? 'active' : '' }}">
                <a class="sidebar-link" href="{{ url('adminHome') }}">
...
<!--             <li class="sidebar-item {{ request()->is('profile') ? 'active' : '' }}">
            ...
            <li class="sidebar-item {{ request()->is('adminProduct') && !request()->is('adminHome') ? 'active' : '' }}">
                <a class="sidebar-link" href="{{ url('adminProduct') }}">
